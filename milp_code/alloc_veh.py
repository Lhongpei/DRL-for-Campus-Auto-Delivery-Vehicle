...
from milp_code.utils import dis, generW, power, draw_locations_opt, rand_create_Boxes, rand_gener_map
...
class AllocVeh:
    ...
    """
    def __init__(self, init_point=None, locs=None, boxes=None, dist=None, T=None):
        """
        Initializes the AllocVeh object.
        ...
        Args:
            ...
            dist (float, optional): The dist of the vehicle. Defaults to None.
        ...
        self.dist = dist
        self.T = T
        if init_point is not None and locs is not None and boxes is not None and dist is not None:
            self.complete = True
        if self.complete:
            self._preprocess()
        print(f'Initializing model, {self.num_locs} locations and {self.num_boxes} boxes')
    
    def input_data(self, init_point, locs, boxes, dist, T=None):
        """
        Sets the input data for the problem.
        ...
        Args:
            ...
            locs (list): List of locations.
            boxes (list): List of boxes.
            velocity (float): The dist of the vehicle.
            T (float, optional): Time constraint for the problem. Defaults to None.
        """
        self.locs = locs
        self.boxes = boxes
